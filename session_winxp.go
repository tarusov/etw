...
// subscribeToProvider wraps EnableTrace
...
// unsubscribeFromProvider wraps EnableTrace.
...
// Event is a single event record received from ETW provider.
type Event struct {
	Header      EventHeader
